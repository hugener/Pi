...
namespace Pi.IO.Components.Displays.Sda5708
{
    public sealed class Sda5708Connection : IDisposable
    {
        ...
        {
            this.baseConnection[this._sdclk] = false;
            this.baseConnection[this._load] = false;

            for (var i = 8; i > 0; i--)
            {
                this.baseConnection[this._data] = (value & 0x1) == 0x1;

                this.baseConnection[this._sdclk] = true;
                this.baseConnection[this._sdclk] = false;
            ...
            this.baseConnection[this._sdclk] = false;
            this.baseConnection[this._load] = true;
        }

        #region IDisposable implementation
        public void Dispose()
        {
            this.baseConnection[this._reset] = false;
