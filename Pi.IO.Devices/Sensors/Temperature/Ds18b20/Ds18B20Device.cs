// <copyright file="Ds18B20Device.cs" company="Pi">
// Copyright (c) Pi. All rights reserved.
// Licensed under the MIT license. See LICENSE file in the project root for full license information.
// </copyright>

namespace Pi.IO.Devices.Sensors.Temperature.Ds18b20
{
    using global::System;
    ...
    public class Ds18B20Device : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Ds18B20Device" /> class.
        /// </summary>
        /// <param name="deviceId">The device identifier.</param>
        /// <exception cref="ArgumentException">Thrown if deviceFolder does not exists.</exception>
        public Ds18B20Device(string deviceId)
        {
        ...
        public Ds18B20Device(int deviceIndex)
        {
