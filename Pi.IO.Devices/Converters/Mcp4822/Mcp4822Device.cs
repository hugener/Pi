// <copyright file="Mcp4822Device.cs" company="Pi">
// Copyright (c) Pi. All rights reserved.
// Licensed under the MIT license. See LICENSE file in the project root for full license information.
// </copyright>

namespace Pi.IO.Devices.Converters.Mcp4822
{
    ...
    public class Mcp4822Device : IDisposable
    {
        private readonly SpiConnection spiConnection;

        /// <summary>
        /// Initializes a new instance of the <see cref="Mcp4822Device" /> class.
        /// </summary>
        /// <param name="clockPin">The clock pin.</param>
        /// <param name="slaveSelectPin">The slave select pin.</param>
        /// <param name="mosiPin">The mosi pin.</param>
        public Mcp4822Device(IOutputBinaryPin clockPin, IOutputBinaryPin slaveSelectPin, IOutputBinaryPin mosiPin)
        {
