// <copyright file="Ssd1306Device.cs" company="Pi">
...
namespace Pi.IO.Devices.Displays.Ssd1306
{
    ...
    public class Ssd1306Device
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Ssd1306Device"/> class.
        /// </summary>
        /// <param name="connection">The connection.</param>
        /// <param name="displayWidth">The display displayWidth.</param>
        /// <param name="displayHeight">The display displayHeight.</param>
        public Ssd1306Device(I2cDeviceConnection connection, int displayWidth = 128, int displayHeight = 64)
        {
