// <copyright file="Sda5708Device.cs" company="Pi">
// Copyright (c) Pi. All rights reserved.
// Licensed under the MIT license. See LICENSE file in the project root for full license information.
// </copyright>

namespace Pi.IO.Devices.Displays.Sda5708
{
    /* Sda5708Connection
 ...
 * with additional german characters added. */
    ...
    public sealed class Sda5708Device : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Sda5708Device"/> class.
        /// </summary>
        public Sda5708Device()
            : this(
            ProcessorPin.Pin7,
            ProcessorPin.Pin8,
            ProcessorPin.Pin18,
        ...
        public Sda5708Device(ProcessorPin load, ProcessorPin data, ProcessorPin sdclk, ProcessorPin reset)
        {
            this.load = load;
            this.data = data;
            this.sdclk = sdclk;
        ...
        private void WriteChar(int position, char value)
        {
            ...
            if (!Sda5708Font.Patterns.TryGetValue(value, out var pattern))
            {
